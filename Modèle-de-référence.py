...
# le code
by_sex = df.groupby(by='Sex')
by_sex #on peut pas le visualiser vraiment, il pointe sur le dataframe
...
print('ici le count compte le nombre de personnes indépendemment du Values (donc compte le nombre de personnes)')
print('ici sum permet de sommer toutes les valeurs de Survived (donc compte le nb de survivants)')
