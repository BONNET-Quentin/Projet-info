...
# %%
# on peut voir qu'il vaut mieux faire en regardant les densités d'apparition de tip lissé
# le service du soir
...
# Les graphes en diagonale ça représente la densité par défaut sinon on aurait juste y = x
# On observe une correlation tip/total bill car ça fait vite fait une reg.linéaire
sns.pairplot(
    data=df,
    hue='time');
...
# %%
tita = titanic[['pclass', 'age', 'fare', 'sex']]
sns.pairplot(data=tita, hue='sex');
